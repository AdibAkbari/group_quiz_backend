...
describe('Quiz Id invalid', () => {
  ...
  test('Quiz Id does not refer to a quiz that this user owns', () => {
    let user2 = adminAuthRegister('email2@gmail.com', 'password1', 'FirstnameB', 'LastnameB');
    expect(adminQuizInfo(user2.authUserId, quiz.quizId)).toStrictEqual(ERROR);
    let quiz2 = adminQuizCreate(user2.authUserId, 'Dogs', 'A quiz about dogs');
...
describe('Valid inputs', () => {
  ...
  test('more than one quiz created by user', () => {
    let user2 = adminAuthRegister('email2@gmail.com', 'password1', 'FirstnameB', 'LastnameB');
    let quiz2 = adminQuizCreate(user2.authUserId, 'Dogs', 'A quiz about dogs');
    let quiz3 = adminQuizCreate(user.authUserId, 'Birds', 'A quiz about birds');
